//this is the edited version of midi.js from jsmidi.js-master
 ...
 * default values for pitch, channel, duration and volume.
 *
...
MidiEvent.createNote = function(note, channel) {
  ...
  //  if (!sustained) {
        ...
        events.push(MidiEvent.noteOff(note, channel));
   // }
 ...
 */
MidiEvent.noteOn = function(note, channel) {
